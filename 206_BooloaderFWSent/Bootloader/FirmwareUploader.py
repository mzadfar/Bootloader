...
def main():
    ...
    fileName = 'final.bin'  # Replace with the actual filename
    ...
    deviceIDPacket = Packet(2, bytes([BOOTLOADER_PACKET_DEVICE_ID_RESPONSE_DATA0, DEVICE_ID]))
    write_packet(deviceIDPacket.toBuffer())
    Logger.info(f'Responding with device ID: 0x{DEVICE_ID:02x}')
